(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SolTabs = {}));
...
`;
  ...
  function _ensureHandler(tag) {
    ...
    import(new URL(`./${tag}.js`, (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('sol-tabs.umd.js', document.baseURI).href))).href).catch(() => {});
  }

  define('sol-tabs', SolTabs);

  exports.SolTabs = SolTabs;
  exports.default = SolTabs;
